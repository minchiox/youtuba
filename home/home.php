...
<head>
  ...
  <meta charset="UTF-8">
    ...
    <link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.theme.default.css'><link rel="stylesheet" href="./home.css">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="javascript:void(0);"><i class="fas fa-igloo"></i>Home</a>
                </li>
                <li class="nav-item">
...
<!-- Fine Navbar -------------------------->
<div class="benvenuto"><h2 class="benvenuto_utente">Benvenuto, <?php echo $_SESSION['fullname']; ?>!</h2></div>
<div class="content">
  <a class="card" href="#!">
    ...
    <div class="back">
      <div class="card-text">
        <h5><b>Sei pronto ad entrare nel magico mondo della musica?</b></h5>
        <p>Seguici in questa esperienza alla scoperta della Tuba.</p>
        <button class="button" onclick="location.href=location.href='../sliderD/storia.php';">Insegnamenti!</button>
      </div>
    ...
    <div class="back">
      <div class="card-text">
        <h5><b>Sai già ciò che c'è da sapere?</b></h5>
        <p>Prova il nostro quiz per mettere alla prova le tue conoscenze</p>
        <button class="button" onclick="location.href='../quiz/quiz';">Quiz!</button>
      </div>
    </div></a>
</div>
