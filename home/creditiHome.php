...
<head>
  ...
  <link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.5.0/css/bootstrap.min.css'><link rel="stylesheet" href="../Index/index.css">
  ...
  <link rel="stylesheet" href="../credits/3D_card.css">
  <link rel="stylesheet" href="../fixed.css">
  <link rel="stylesheet" href="./homeaiuto.css">
  <link href='https://fonts.googleapis.com/css?family=Poppins' rel='stylesheet'>
  <title>Youtuba - Credits</title>
  <meta charset="UTF-8">
</head>
<body>
  ...
  <nav class="navbar navbar-expand-custom navbar-mainbg">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="aiutoHome.php"><i class="fa-solid fa-circle-question"></i>Aiuto</a>
            <li class="nav-item active">
                <a class="nav-link" href="javascript:void(0)"><i class="fa-regular fa-face-grin-tongue-wink"></i>Crediti</a>
            </li>
        </ul>
    </div>
  </nav>
  <div class="div-card">
    <a alt="antonio" target="_blank" class="a-card">
      <div class="card">
        <div class="wrapper">
          <img src="../credits/stefano.jpg" class="cover-image" />
        </div>
        <img src="" class="title" />
        <img src="../credits/stefano.png" class="character" />
        <div class="description2"><h5>Stefano Sternativo</h5>Esperto del dominio & multimedialità</div>
      </div>
    </a>
    <a alt="antonio" target="_blank" class="a-card">
      <div class="card">
        <div class="wrapper">
          <img src="../credits/vincenzo.jpg" class="cover-image" />
        </div>
        <img src="" class="title" />
        <img src="../credits/vincenzo.png" class="character" />
        <div class="description"><h5>Vincenzo Altavilla</h5>Technical writer</div>
      </div>
    </a>
    <a alt="antonio" target="_blank" class="a-card">
      <div class="card">
        <div class="wrapper">
          <img src="../credits/antonio.jpg" class="cover-image" />
        </div>
        <img src="" class="title" />
        <img src="../credits/antonio.png" class="character" />
        <div class="description2"><h5>Antonio Levrè</h5>Fullstack developer<br>& graphic designer</div>
      </div>
    </a>
    <a alt="antonio" target="_blank" class="a-card">
      <div class="card">
        <div class="wrapper">
          <img src="../credits/donato.jpg" class="cover-image" />
        </div>
        <img src="" class="title" />
        <img src="../credits/donato.png" class="character" />
        <div class="description"><h5>Donato Raimondi</h5>Fullstack developer</div>
      </div>
    </a>
    <a alt="antonio" target="_blank" class="a-card">
      <div class="card">
        <div class="wrapper">
          <img src="../credits/michele.jpg" class="cover-image" />
        </div>
        <img src="" class="title" />
        <img src="../credits/michele.png" class="character" />
        <div class="description2"><h5>Michele Capuzzimati</h5>Graphic designer & coding helper</div>
      </div>
    </a>
</div>
