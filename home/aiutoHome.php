...
<html lang="it">
  <head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/css/all.min.css"><link rel="stylesheet" href="../Menu/style.css"><link rel="stylesheet" href="../home.css">
    <link href='https://fonts.googleapis.com/css?family=Poppins' rel='stylesheet'>
    <link rel="stylesheet" href="../Aiuto/aiuto.css">
    <link rel="stylesheet" href="../home/homeaiuto.css">
    <meta charset="UTF-8">
    <title>Youtuba - Mappa</title>
  </head>
  <body>
    ...
    <nav class="navbar navbar-expand-custom navbar-mainbg">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                  <a class="nav-link" href="home.php"><i class="fas fa-igloo"></i>Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="mappaHome.php"><i class="fas fa-map"></i>Mappa</a>
              </li>
              <li class="nav-item active">
                  <a class="nav-link" href="javascript:void(0);"><i class="fa-solid fa-circle-question"></i>Aiuto</a>
              <li class="nav-item">
                  <a class="nav-link" href="creditiHome.php"><i class="fa-regular fa-face-grin-tongue-wink"></i>Crediti</a>
              </li>
          </ul>
      </div>
    </nav>
    <div class="help-page">
      <div class="help_section">
          <h1>Sezione bottoni di aiuto</h1>
          <ul class="tendina">
            <li>
              <input type="checkbox" checked>
              <i></i>
              <h2>Guida alla schermata Home</h2>
              <p><img src="../grafica/Immagini/aiuto/insegnamento.png" alt="bottone accedi" id="imga" width="100" height="100"><img src="../grafica/Immagini/aiuto/quiz.png" alt="bottone quiz" id="imga" width="100" height="100"><br><br>Se si fa hover con il mouse su queste carte, riveleranno al loro interno il pulsante che permette di accedere alla rispettiva area di interesse. Di seguito i bottoni rivelati all'interno delle card:<br><br> <img src="../grafica/Immagini/aiuto/insegnamento12.png" alt="bottone accedi" id="imga"> <img src="../grafica/Immagini/aiuto/quizz.png" alt="bottone quiz" id="imga">
               </p>
              <hr>
            </li>
          <li>
              <input type="checkbox" checked>
              <i></i>
              <h2>Guida alla schermata insegnamento</h2>
              <p>Scegliendo l'area "insegnamento", vi troverete nella sezione che rigurda, appunto, la sezione di apprendimento. <br> Con questi bottoni potrai scegliere quale area d'insegnamento vedere:<br><br><img src="../grafica/Immagini/aiuto/Storia.png" alt="bottone accedi" id="imga"><img src="../grafica/Immagini/aiuto/elear.png" alt="bottone registrati" id="imga"><br><br>Con questi invece potrai spostarti tra le slide, oltre che usare le freccie sinistra e destra della tastiera <img src="../grafica/Immagini/aiuto/sx.png" alt="bottone accedi" id="imga"><img src="../grafica/Immagini/aiuto/dx.png" alt="bottone registrati" id="imga"></p>
              <hr>
            </li>
            <li>
                <input type="checkbox" checked>
                <i></i>
                <h2>Guida alla sezione Quiz</h2>
                <p>In questa sezione potrete mettervi alla prova con un quiz a 10 domande.</p>
                <hr>
            </li>
            <li>
              <input type="checkbox" checked>
              <i></i>
              <h2>Barra della navigazione</h2>
              <p><img src="../grafica/Immagini/aiuto/home.png" alt="bottone home" id="imga">
              <img src="../grafica/Immagini/aiuto/mappa.png" alt="bottone mappa" id="imga"><img src="../grafica/Immagini/aiuto/aiuto.png" alt="bottone aiuto" id="imga"><img src="../grafica/Immagini/aiuto/crediti.png" alt="bottone crediti" id="imga"> <br><br>Questi sono i bottoni presenti nella barra di navigazione, sempre presente in ogni parte del programma. La funzionalità del bottone è strettamente legata a ciò che vi è scritto all'interno.</p>
            <hr>
            </li>
            <li>
            <input type="checkbox" checked>
            <i></i>
              <h2>Ritorna alla splash screen</h2>
              <p><img src="../grafica/Immagini/exit2.svg" alt="bottone crediti" id="imga" width="100" heigth="100"><br><br>Pulsante presente in ogni parte dell'applicazione. Serve per tornare alla splash screen ed effettuare il logout e se premuto chiederà conferma per effettuare la sua funzione</p>
            <hr>
            </li>
